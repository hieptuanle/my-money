export default function PrivacyPolicy() {
  return (
    ...
    >
      ...
      <p>Effective date: 2020-10-04</p>
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b> My Money</b>.
      </p>
      <p>
        <b>My Money</b> (“us”, “we”, or “our”) operates{" "}
        <b>money.hieptuanle.com</b> (hereinafter referred to as <b>“Service”</b>
        ).
      </p>
      <p>
        Our Privacy Policy governs your visit to <b>money.hieptuanle.com</b>,
      ...
      <p>
        <b>SERVICE</b> means the money.hieptuanle.com website operated by My
        Money.
      </p>
      <p>
      ...
      <p>My Money uses the collected data for various purposes:</p>
      ...
      <p>
        If you are located outside Vietnam and choose to provide information to
        us, please note that we transfer the data, including Personal Data, to
        Vietnam and process it there.
      </p>
      <p>
      ...
      <p>
        My Money will take all the steps reasonably necessary to ensure that
      ...
      <p>
        ...
        please send your request(s) by email: <b>support@hieptuanle.com</b>.
      </p>
      <p>
      ...
      <p>
        ...
        by email: <b>support@hieptuanle.com</b>.
      </p>
      <p>
        This <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a>{" "}
        was created for <b>money.hieptuanle.com</b> by{" "}
