export default function Terms() {
  return (
    <div style={{ margin: 20 }}>
      ...
      <p>Last updated: 2020-10-04</p>
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b>My Money</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>money.hieptuanle.com</b> (together or
        individually “Service”) operated by <b>My Money</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>support@hieptuanle.com</b> so we can try to find a solution. These
      ...
      <p>
        ...
        following the unsubscribe link or by emailing at support@hieptuanle.com.
      </p>
      ...
      <p>
        Content found on or through this Service are the property of My Money or
      ...
      <p>
        ...
        My Money and its licensors. Service is protected by copyright,
      ...
      <p>
        ...
        to support@hieptuanle.com, with the subject line: “Copyright
      ...
      <p>
        You can contact our Copyright Agent via email at support@hieptuanle.com.
      </p>
      <p>
        12. <b>Error Reporting and Feedback</b>
      </p>
      <p>
        You may provide us either directly at support@hieptuanle.com or via
      ...
      <p>
        ...
        are not owned or controlled by My Money.
      </p>
      <p>
        My Money has no control over, and assumes no responsibility for the
      ...
      <p>
        ...
        email: <b>support@hieptuanle.com</b>.
      </p>
      <p>
        These{" "}
        <a href="https://policymaker.io/terms-and-conditions/">
        ...
        were created for <b>money.hieptuanle.com</b> by{" "}
        <a href="https://policymaker.io">PolicyMaker.io</a> on 2020-10-04.
      </p>
    </div>
  );
}
